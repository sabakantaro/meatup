...
const createBookmark = (eventId, data)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].post(`events/${eventId}/bookmarks`, data);
};
const deleteBookmark = (eventId, id)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](`/events/${eventId}/bookmarks/${id}`);
};
