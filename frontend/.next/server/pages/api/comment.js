...
const createComment = (eventId, data)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].post(`/events/${eventId}/comments`, data);
};
const deleteComment = (eventId, id)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](`/events/${eventId}/comments/${id}`);
};
