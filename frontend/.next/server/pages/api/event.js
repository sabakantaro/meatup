...
const getEvents = ()=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].get("/events");
};
const getEvent = (id)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].get(`/events/${id}`);
};
const createEvent = (data)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].post("/events", data);
};
const deleteEvent = (id)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](`/events/${id}`);
};
...
var __webpack_exports__ = (__webpack_exec__(9827));
