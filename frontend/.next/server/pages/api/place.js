...
/* harmony export */   "deletePlace": () => (/* binding */ deletePlace),
...
const getPlaces = ()=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].get("/places");
};
const createPlace = (data)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"].post("/places", data);
};
const deletePlace = (id)=>{
    return _client__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](`/places/${id}`);
};
